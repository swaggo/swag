...
Or download a pre-compiled binary from the [release page](https://github.com/nguyennm96/swag/releases).
...
Find the example source code [here](https://github.com/nguyennm96/swag/tree/master/example/celler).
...
Find the result of formatting [here](https://github.com/nguyennm96/swag/tree/master/example/celler).
...
[#708](https://github.com/nguyennm96/swag/issues/708) The parser handles only struct comments starting with `@Description` attribute.
...
[#980](https://github.com/nguyennm96/swag/issues/980)
[#1177](https://github.com/nguyennm96/swag/issues/1177)
