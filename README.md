...
Or download a pre-compiled binary from the [release page](https://github.com/Nerzal/swag/releases).
...
Find the example source code [here](https://github.com/Nerzal/swag/tree/master/example/celler).
...
**Example**
[celler/main.go](https://github.com/Nerzal/swag/blob/master/example/celler/main.go)
...
**Example**
[celler/controller](https://github.com/Nerzal/swag/tree/master/example/celler/controller)
