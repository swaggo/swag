...
func TestParseTypeOverrides(t *testing.T) {
	...
	p := New(SetOverrides(map[string]string{
		"github.com/griffnb/swag/testdata/global_override/types.Application":  "string",
		"github.com/griffnb/swag/testdata/global_override/types.Application2": "github.com/griffnb/swag/testdata/global_override/othertypes.Application",
		"github.com/griffnb/swag/testdata/global_override/types.ShouldSkip":   "",
	}))
	err := p.ParseAPI(searchDir, mainAPIFile, defaultParseDepth)
	assert.NoError(t, err)
...
func TestParser_skipPackageByPrefix(t *testing.T) {
	...
	assert.False(t, parser.skipPackageByPrefix("github.com/griffnb/swag"))
	assert.False(t, parser.skipPackageByPrefix("github.com/griffnb/swag/cmd"))
	assert.False(t, parser.skipPackageByPrefix("github.com/griffnb/swag/gen"))

	parser = New(SetPackagePrefix("github.com/griffnb/swag/cmd"))

	assert.True(t, parser.skipPackageByPrefix("github.com/griffnb/swag"))
	assert.False(t, parser.skipPackageByPrefix("github.com/griffnb/swag/cmd"))
	assert.True(t, parser.skipPackageByPrefix("github.com/griffnb/swag/gen"))

	parser = New(SetPackagePrefix("github.com/griffnb/swag/cmd,github.com/swaggo/swag/gen"))
