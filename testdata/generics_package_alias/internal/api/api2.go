...
import (
	myv1 "github.com/nguyennm96/swag/v2/testdata/generics_package_alias/internal/path1/v1"
	myv2 "github.com/nguyennm96/swag/v2/testdata/generics_package_alias/internal/path2/v1"
)
