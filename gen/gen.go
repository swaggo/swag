...
type Config struct {
	...
	// DocInit is used to generate doc.go with Register func to manually register swagger
	// if false uses init with import instead
	DocUserRegister bool
...
var (
	packageTemplate = `// Package {{.PackageName}} GENERATED BY THE COMMAND ABOVE; DO NOT EDIT
